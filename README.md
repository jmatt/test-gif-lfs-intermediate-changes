...
test-gif-lfs-intermediate-changes stores large files using [git-lfs](https://git-lfs.github.com/). To use test-gif-lfs-intermediate-changes you must install git-lfs and configure it. LSST runs its own git-lfs server and storage service.
